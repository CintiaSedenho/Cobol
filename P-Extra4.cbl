       ...
       FILE-CONTROL.
           SELECT ARQ-PRODUTOS ASSIGN TO DISK
       ...
       data division.
       FILE SECTION.
       FD ARQ-PRODUTOS LABEL RECORD STANDARD
       ...
       01 REG-PRODUTO.
           02 CODIGO-P PIC 9(4).
           02 NOME1-P PIC X(30).
           02 QTDADE1-P PIC 9(4).
           02 UNIT1-P PIC 9(5)V99.
           02 TOTAL1-P PIC 9(6)V99.
       01 ARQ-OK PIC X(2).
...
* ----------------------------Inicialização das variáveis
       ...
       RECEBE.
           PERFORM TESTA-COD UNTIL CODIG-P > 0.
