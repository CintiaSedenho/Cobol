       ...
       01 DATA-SIS.
           ...
           05 MES          PIC 99.
           05 DIA          PIC 99.
       01 CLI-STATUS       PIC 9(2) VALUE ZEROS.
       ...
       MENU-ALTERA.
           ...
           PERFORM ABRE-ARQ.
           PERFORM RECEBE-CPF.
           PERFORM ALTERA UNTIL SALVA = "S" OR "N" OR "s" OR "n".
           CLOSE CLIENTES.
           PERFORM MENU-PRI.
       ...
       MENU-EXCLUI.
           ...
           PERFORM ABRE-ARQ.
           PERFORM RECEBE-CPF.
           PERFORM DELETA UNTIL SALVA = "S" OR "N" OR "s" OR "n".
           CLOSE CLIENTES.
           PERFORM MENU-PRI.
      ...
      *   --É PRECISO ZERAR NOVAMENTE OS CAMPOS-------------
       ...
       GRAVA.
           ...
           WRITE REG-CLI
               INVALID KEY
                   ...
                   PERFORM MENU-PRI
               NOT INVALID KEY
                   DISPLAY "REGISTRO INSERIDO!" AT 1535
                   ACCEPT CR
                   PERFORM MENU-PRI
               CLOSE CLIENTES
           END-WRITE.
       ...
       DELETA.
           ...
           END-DELETE.
               ...
               PERFORM MENU-PRI.
       AVISO.
           DISPLAY "** PRESSIONE QUALQUER TECLA PARA VOLTAR **".
